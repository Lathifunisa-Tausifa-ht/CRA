...
# ✅ Use system_prompt parameter (v1 renamed from prompt)
agent = create_agent(
    model=llm,
    tools=[parse_pdf_tool],
    system_prompt="You are the Regulation Monitor Agent. When given a PDF filepath, call parse_pdf_tool with that filepath and return the JSON output."
)
...
class RegulationConsumer(stomp.ConnectionListener):
    ...
    def on_message(self, frame):
        ...
        try:
            ...
            # Now extract based on what you see
            ...
            print(f"[DEBUG] Extracted response: {raw_response}")
